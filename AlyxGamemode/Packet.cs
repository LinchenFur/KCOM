    ...
    public class Packet
    {
        ...
        public bool IsValid()
        {
            ...
            return type switch
            {
                ...
                PacketType.PhysicsObjectPosAng => (args.Length == 8 || args.Length == 14) && IsSafeToken(args[0]) && AreFiniteNumbers(1, args.Length == 14 ? 12 : 6),
                ...
                PacketType.RagdollSpawn => args.Length == 9 && IsSafeToken(args[0]) && IsSafeToken(args[7]) && AreFiniteNumbers(1, 6),
